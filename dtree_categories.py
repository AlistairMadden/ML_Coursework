...
def dtree(attribute_training_filename, label_training_filename,
          attribute_testing_filename, label_testing_filename, data_path="./", max_categories=2):
    ########### Define classes
...
if (__name__ == "__main__"):
    ...
    for max_categories in range(2, 11):
        ...
        for classification in combined_dict:
            total_summary.append([classification, max_categories, combined_dict[classification][0],
    ...
    writer = csv.writer(open("dtree_cat-2-10_depth-30_count-10.csv", "wt", encoding='ascii', newline=''), delimiter=',')
